    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <motion.button
          ...
          onClick={toggleTheme}
          aria-label={isUtopian ? 'Switch to Dystopian Reality' : 'Switch to Utopian Reality'}
          role="switch"
          aria-checked={isUtopian}
          className="fixed top-4 right-4 md:top-8 md:right-8 z-20 group max-w-[calc(50vw-2rem)] sm:max-w-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-amber-400 focus-visible:outline-none rounded-lg"
        >
      ...
      <TooltipContent>
        <p>Switch between Utopian and Dystopian realities</p>
      </TooltipContent>
    </Tooltip>
  );
}
