...
/// Pre-populates form fields with current habit data
...
class _EditHabitScreenState extends State<EditHabitScreen> {
  ...
  void _loadHabitData() {
    ...
    setState(() {
      ...
      _preHabitRitualController.text = habit.preHabitRitual ?? '';
      _environmentCueController.text = habit.environmentCue ?? '';
      _environmentDistractionController.text = habit.environmentDistraction ?? '';
  ...
  Future<void> _saveHabit() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      // Create updated habit preserving id, streak, and creation date
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            '${_originalHabit!.currentStreak} day streak',
