                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: const Text('About The Pact'),
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('Version 5.7.0'),
                        trailing: const Icon(Icons.chevron_right),
      ...
      builder: (context) => AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                'The Pact is built on proven behavioural science:',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              SizedBox(height: 16),
              Text(
              ...
              SizedBox(height: 4),
              Text('• Witness-based commitment'),
              Text('• Public declaration of intent'),
              Text('• Mutual accountability loops'),
              SizedBox(height: 12),
              Text(
              ...
              SizedBox(height: 4),
              Text('• Become the person who keeps promises'),
              Text('• Small wins compound into identity'),
              ...
              Text('• Recovery over perfection'),
              Text('• Progress, not streaks'),
              SizedBox(height: 16),
              Text(
                'Our Philosophy: Your word is your bond.',
                style: TextStyle(
                  fontStyle: FontStyle.italic,
                  fontWeight: FontWeight.w500,
                ),
  ...
  void _showAboutDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AboutDialog(
        ...
        applicationLegalese: '© 2025 Crony\n\n'
            'Built with Flutter and ❤️\n\n'
            'A social contract for your habits',
        children: const [
          SizedBox(height: 16),
          Text(
            'Features:',
          ...
          SizedBox(height: 8),
          Text('✅ AI-Powered Habit Creation'),
          Text('✅ Voice Conversations with The Architect'),
          Text('✅ Witness-Based Accountability'),
          Text('✅ Social Contracts & Pacts'),
          Text('✅ Weekly AI Reviews'),
