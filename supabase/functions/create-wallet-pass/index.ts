...
// Phase 25.3: Google Wallet Pass JWT Signing Service
//
// This function:
// 1. Authenticates the user via Supabase Auth JWT
// 2. Creates a GenericObject for the user's Pact (habit commitment)
// 3. Signs the JWT using the Google Cloud service account key
// 4. Returns the "Add to Google Wallet" URL
//
  ...
  try {
    ...
    const genericObject = {
      ...
      linksModuleData: {
        uris: [
          {
            uri: `https://thepact.co/pact/${requestBody.pactId}`,
            description: 'View in The Pact',
            id: 'view_pact'
          },
          {
            uri: 'https://thepact.co',
      ...
      barcode: {
        type: 'QR_CODE',
        value: `thepact://checkin/${requestBody.pactId}`,
