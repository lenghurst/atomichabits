...
| **Status** | ✅ RESOLVED |
| **Resolved** | 10 January 2026 |
| **Resolution** | Option C: Constitutional Amendment Model |
| **Priority** | **HIGH** — Core to treaty lifecycle |
| **Generated By** | RQ-021 gap analysis |

**Resolution: Constitutional Amendment Model**

RQ-024 research confirmed Option C with full specification:

**Amendment Classification:**

| Type | When | Ceremony | Breach History |
|------|------|----------|----------------|
| **Minor** | Parameter changes (time, count, soft/hard) | 3s Re-Ratification | PRESERVED |
| **Major** | Logic changes or signatories | Council reconvene | RESET (Amnesty) |

**Treaty State Machine:**

| State | Trigger | User Options |
|-------|---------|--------------|
| **Active** | Normal operation | Edit, Pause, Repeal |
| **Probation** | 5 breaches OR 3 dismissed | Fix, Pause, Repeal (4-day window) |
| **Paused** | User-initiated | Resume (max 14 days) |
| **Suspended** | System-initiated (T+96h) | Renegotiate only |
| **Repealed** | Type "REPEAL" | Archived permanently |

**Key UX Decisions:**
- **Re-Ratification:** 3-second long-press (same pattern as original Ratification but simpler)
- **Probation Journey:** T+0 → T+24h → T+72h → T+96h escalation with user agency windows
- **Pause Limit:** 14 days max to prevent indefinite avoidance
- **Repeal Safety:** Type "REPEAL" to confirm (prevents accidental deletion)

**Resolved By:** RQ-024 (Treaty Modification Flow)

**Tasks Generated:** See RESEARCH_QUESTIONS.md → Master Implementation Tracker (A-11, A-12, B-16, B-17, C-13, D-11 through D-14)
...
| Field | Value |
|-------|-------|
| **Question** | When should AI Agent Protocols be consolidated, and what governance triggers future protocol additions? |
| **Status** | 🔴 PENDING |
| **Priority** | **LOW** — Future governance, not blocking current work |
| **Generated By** | Protocol 10-12 Implementation Audit (11 Jan 2026) |

**Context:**
AI_AGENT_PROTOCOL.md now has 12 mandatory protocols (up from 9). Cognitive science suggests working memory limits of 7±2 items. While AI agents can re-read protocols, maintainability concerns grow with protocol count.

**The Questions:**
1. At what protocol count should consolidation be triggered? (15? 20?)
2. Should protocols be grouped (e.g., "Meta-Protocols 10-12")?
3. What criteria govern adding NEW protocols vs refining existing ones?
4. Should there be a Protocol Deprecation process?

**Proposed Governance Framework:**

| Protocol Count | Action |
|----------------|--------|
| **1-12** | Current state — no action |
| **13-15** | Audit for overlap; consider consolidation |
| **16+** | Mandatory consolidation review before adding new |

**Consolidation Candidates (Future):**

| Protocols | Possible Merge |
|-----------|----------------|
| 10, 11, 12 | "Meta-Cognitive Suite" — already grouped conceptually |
| 8, 9 | "External Integration" — both handle external inputs |
| Session Entry + Exit | "Session Bookends" — one protocol with IN/OUT modes |

**Depends On:** Nothing — this is governance for governance.

**Trigger:** When protocol count reaches 15.
