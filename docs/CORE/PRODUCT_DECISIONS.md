...
| **Status** | 🔴 PENDING — Requires RQ-021 |
| **Priority** | **HIGH** — Core to Council AI value |
...
| Approach | Pros | Cons |
|----------|------|------|
| **Council AI Only** | Meaningful experience, proper negotiation | Friction for simple treaties |
| **Ad-hoc + Council** | Flexibility, lower friction | May feel less "official" |
| **Templates + Council** | Fast start, guided, still meaningful | Template design complexity |

**Options:**

| Option | Description | Recommendation |
|--------|-------------|----------------|
| A | Treaties ONLY through Council AI sessions | ❌ Too restrictive |
| B | Ad-hoc treaties + Council AI for complex conflicts | ⚠️ May dilute Council value |
| **C** | **Templates + Council AI; no fully ad-hoc** | ✅ **RECOMMENDED** |

**Option C Details:**
- Users can browse treaty templates and activate with 1-click
- For custom treaties, must convene Council AI to negotiate terms
- Templates feel "quick" but are still psychologically grounded

**Proposed Template Categories:**
| Category | Example | Logic Hook Type |
|----------|---------|-----------------|
| Time Protection | "Protected Family Night" | Block by day/time |
| Focus Mode | "Deep Work Guardian" | Block distractions |
| Balance | "Weekend Reset" | Enforce variety |
| Boundaries | "Sacred Sleep" | Block after hour |

**Depends On:** RQ-021 (Treaty Lifecycle & UX)
